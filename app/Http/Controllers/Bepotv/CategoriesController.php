...
class CategoriesController extends Controller
{
    public function getIndex() {
        $filter=DataFilter::source(new Video_Class());
        ...
        $grid->edit('bepotvcategories/edit','操作','show|modify')->style('width:12%');
        $grid->link('bepotvcategories/edit',"新增","TR");
    ...
    public function anyEdit() {
        ...
        $edit->link("bepotvcategories","回列表","TR")->back();

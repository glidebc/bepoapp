						...
						<div class="row">
							<div class="col-sm-12">
								<table id="" class="table table-bordered table-hover dataTable" role="grid" >
									<thead>
										<tr role="row">
											<th tabindex="0"  rowspan="1" colspan="1" aria-sort="ascending" >標題</th>
											<th tabindex="1"  rowspan="1" colspan="1" >作者</th>
											<th tabindex="2"  rowspan="1" colspan="1" >分類</th>
											<th tabindex="3"  rowspan="1" colspan="1" >迴響</th>
											<th tabindex="4"  rowspan="1" colspan="1" >日期</th>
											<th tabindex="5"  rowspan="1" colspan="1" >Views</th>
									...
									<tbody>
										...
										<tr role="row" class="{{($idx+1)%2>0?'odd':'even'}}">
											<td><a href='{{url('posts/edit/0')}}'>{{$user->post_title}}</a></td>
